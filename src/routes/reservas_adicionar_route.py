...
# Serviços
from services.reservas_service import add_reserva
...
from utils.date_util import convert_str_date_to_format
...
def reservas_adicionar(page: ft.Page) -> tp.Tuple[tp.Callable, ft.View]:
    """Página de adicionar reserva"
    
    Página para adicionar uma nova reserva.
    ...
    Returns:
        ...
        ft.View: Página de adicionar reserva
    """
    # Inicialização
    def init():
        for ref in [dono_ref, espaco_ref, data_inicio_ref, horario_inicio_ref, data_termino_ref, horario_termino_ref]:
            ref.current.value = ""
    ...
    check_interval = validate_ref(
        ...
        validate_intervalo,
        [espaco_ref, data_inicio_ref, horario_inicio_ref, data_termino_ref, horario_termino_ref],
        [
            validate_ref(
